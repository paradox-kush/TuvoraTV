...
class KitsuSettingsDataStore @Inject constructor(
    private val factory: ProfileDataStoreFactory,
    private val profileManager: ProfileManager
) {
    companion object { private const val FEATURE = "kitsu_settings" }
    ...
    val settings: Flow<KitsuSettings> = profileManager.activeProfileId.flatMapLatest { profileId ->
