...
internal suspend fun HomeViewModel.loadAllCatalogsPipeline(
    ...
    clearCatalogData()
    // catalogOrder / catalogsMap just got wiped; reset tracker key tracking
    // too or the next apply will think the tracker rows still exist and
    // skip re-inserting them.
